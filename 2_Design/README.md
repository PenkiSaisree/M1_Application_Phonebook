...
``` NOTE: The diagram of behavioral is keep it in image file for reference.``` - High level
![Low level diagram for phonebook](https://image.slidesharecdn.com/svrohith9-151115084712-lva1-app6892/95/a-c-program-of-phonebook-application-8-638.jpg?cb=1453036615)
