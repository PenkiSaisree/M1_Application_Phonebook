# 1. Requirements
Phone book application is primarily meant for keeping the records of the persons. This application contains how to add, list, modify or edit, search and delete data to/from the file. 
